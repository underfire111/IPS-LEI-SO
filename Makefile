...
test_5:		compile | $(TEST_PATH)
		...
		@ for number in $(COUNTER); do									\
			./$(NAME) $(BOOST) $$number $(PATH_TEST)/ex05.txt 3 1 ;		\
		done ;
		@ printf "\n>>>> ex05 \n\n"
...
test_8:		compile | $(TEST_PATH)
		@ printf "| Test | Time | Threads |  Goal  | Result | Iterations | Result Time |\n"
		@ for number in $(COUNTER); do									\
			./$(NAME) $(BOOST) $$number $(PATH_TEST)/ex08.txt 3 1 ;		\
		done ;
		@ printf "\n>>>> ex08 \n\n"
...
test_20:	compile | $(TEST_PATH)
		@ printf "| Test | Time | Threads |  Goal  | Result | Iterations | Result Time |\n"
		@ for number in $(COUNTER); do									\
			./$(NAME) $(BOOST) $$number $(PATH_TEST)/ex20_878.txt 5 1 ;	\
		done ;
		@ printf "\n>>>> ex20 \n\n"
...
test_40:	compile | $(TEST_PATH)
		@ printf "| Test | Time | Threads |  Goal  | Result | Iterations | Result Time |\n"
		@ for number in $(COUNTER); do									\
			./$(NAME) $(BOOST) $$number $(PATH_TEST)/ex40.txt 10 2 ;	\
		done ;
		@ printf "\n>>>> ex40 \n\n"
...
test_50:	compile | $(TEST_PATH)
		@ printf "| Test | Time | Threads |  Goal  | Result | Iterations | Result Time |\n"
		@ for number in $(COUNTER); do									\
			./$(NAME) $(BOOST) $$number $(PATH_TEST)/ex50_1.txt 10 1 ;	\
		done ;
		@ printf "\n>>>> ex50 \n\n"
...
test_100:	compile | $(TEST_PATH)
		@ printf "| Test | Time | Threads |  Goal  | Result | Iterations | Result Time |\n"
		@ for number in $(COUNTER); do									\
			./$(NAME) $(BOOST) $$number $(PATH_TEST)/ex100_1.txt 15 2 ;	\
		done ;
		@ printf "\n>>>> ex100 \n\n"
...
test_200:	compile | $(TEST_PATH)
		@ printf "| Test | Time | Threads |  Goal  | Result | Iterations | Result Time |\n"
		@ for number in $(COUNTER); do									\
			./$(NAME) $(BOOST) $$number $(PATH_TEST)/ex200_1.txt 20 2 ;	\
		done ;
		@ printf "\n>>>> ex200 \n\n"
